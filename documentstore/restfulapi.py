...
class DocumentsBundleSchema(colander.MappingSchema):
    """Representa o schema de dados do endpoint `bundles`.
    """
...
@manifest.get(
    ...
    response_schemas={
        "200": ManifestSchema(description="Obtém o manifeto do documento"),
...
@assets.put(
    ...
    validators=(colander_body_validator,),
    response_schemas={
        "204": AssetSchema(description="Adicionado ou atualizado o ativo com sucesso"),
...
@front.get(
    ...
    response_schemas={
        "200": FrontDocumentSchema(description="Retorna o front do documento"),
        "404": FrontDocumentSchema(description="Documento não encontrado"),
    },
    renderer="json",
)
...
@bundles.get(
    response_schemas={
        "200": DocumentsBundleSchema(description="Retorna o recurso solicitado"),
